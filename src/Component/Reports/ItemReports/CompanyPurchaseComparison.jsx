...
export default function CompanyPurchaseComparison() {
	...
	const exportPDFHandler = () => {
		...
		const handlePagination = () => {
			...
			while (currentPageIndex * rowsPerPage < rows.length) {
				...
				startY += 7;
				addTitle(
					`Company Purchase Comparison From: ${fromInputDate} To: ${toInputDate}`,
					"",
					"",
					pageNumber,
					startY,
		...
		handlePagination();
		doc.save("CompanyPurchaseComparison.pdf");
	...
	const handleDownloadCSV = async () => {
		...
		saveAs(blob, "CompanyPurchaseComparison.xlsx");
	};
	...
	return (
		<>
			...
			<div style={contentStyle}>
				...
				>
					<NavComponent textdata="Company Purchase Comparison" />
