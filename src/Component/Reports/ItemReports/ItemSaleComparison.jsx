...
export default function ItemSaleComparison() {
	...
	const exportPDFHandler = () => {
		...
		const handlePagination = () => {
			...
			while (currentPageIndex * rowsPerPage < rows.length) {
				...
				startY += 7;
				addTitle(
					`Item Sale Comparison From: ${fromInputDate} To: ${toInputDate}`,
					"",
					"",
					pageNumber,
					startY,
		...
		handlePagination();
		doc.save("ItemSaleComparison.pdf");
	...
	const handleDownloadCSV = async () => {
		...
		saveAs(blob, "ItemSaleComparison.xlsx");
	};
	...
	useHotkeys("s", fetchItemSaleComparison);
	...
	return (
		<>
			...
			<div style={contentStyle}>
				...
				>
					<NavComponent textdata="Item Sale Comparison" />
