...
export default function ItemPurchaseComparison() {
	...
	function fetchItemPurchaseComparison() {
	...
	useHotkeys("s", fetchItemPurchaseComparison);
				...
				>
					...
					>
						...
						<SingleButton
							...
							text="Select"
							ref={selectButtonRef}
							onClick={fetchItemPurchaseComparison}
							style={{ backgroundColor: "#186DB7", width: "120px" }}
							onFocus={(e) => (e.currentTarget.style.border = "2px solid red")}
							onBlur={(e) =>
								(e.currentTarget.style.border = `1px solid ${fontcolor}`)
