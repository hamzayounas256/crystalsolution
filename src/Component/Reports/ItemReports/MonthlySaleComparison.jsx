...
export default function MonthlySaleComparison() {
	...
	function fetchMonthlySaleComparison() {
		const apiMainUrl = apiLinks + "/MonthlySaleComparison.php";
		setIsLoading(true);
	...
	const exportPDFHandler = async () => {
		...
		const handlePagination = () => {
			...
			while (currentPageIndex * rowsPerPage < rows.length) {
				...
				startY += 7;
				addTitle(`Monthly Sale Comparison`, "", "", pageNumber, startY, 14);
				startY += 13;
		...
		handlePagination();
		doc.save("MonthlySaleComparison.pdf");
	...
	const handleDownloadCSV = async () => {
		...
		worksheet.addRow([]);
		[comapnyname, `Monthly Sale Comparison`].forEach((title, index) => {
		...
		saveAs(blob, "MonthlySaleComparison.xlsx");
	};
	...
	useHotkeys("s", fetchMonthlySaleComparison);
	...
	return (
		<>
			...
			<div style={contentStyle}>
				...
				>
					<NavComponent textdata="Monthly Sale Comparison" />
					...
					>
						...
						<SingleButton
							...
							text="Select"
							ref={selectButtonRef}
							onClick={fetchMonthlySaleComparison}
							style={{ backgroundColor: "#186DB7", width: "120px" }}
							onFocus={(e) => (e.currentTarget.style.border = "2px solid red")}
							onBlur={(e) =>
								(e.currentTarget.style.border = `1px solid ${fontcolor}`)
