...
export default function CompanyMonthlySaleComparison() {
	...
	const exportPDFHandler = async () => {
		...
		const handlePagination = () => {
			...
			while (currentPageIndex * rowsPerPage < rows.length) {
				...
				startY += 7;
				addTitle(
					`Company Monthly Sale Comparison`,
					"",
					"",
					pageNumber,
					startY,
		...
		handlePagination();
		doc.save("CompanyMonthlySaleComparison.pdf");
	...
	const handleDownloadCSV = async () => {
		...
		worksheet.addRow([]);
		[comapnyname, `Company Monthly Sale Comparison`].forEach((title, index) => {
		...
		saveAs(blob, "CompanyMonthlySaleComparison.xlsx");
	};
	...
	return (
		<>
			...
			<div style={contentStyle}>
				...
				>
					<NavComponent textdata="Company Monthly Sale Comparison" />
