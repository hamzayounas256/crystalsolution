...
export default function ItemMonthlySaleComparison() {
	...
	const exportPDFHandler = async () => {
		...
		handlePagination();
		doc.save("ItemMonthlySaleComparison.pdf");
	...
	const handleDownloadCSV = async () => {
		...
		worksheet.addRow([]);
		[comapnyname, `Item Monthly Sale Comparison`].forEach((title, index) => {
		...
		saveAs(blob, "ItemMonthlySaleComparison.xlsx");
	};
