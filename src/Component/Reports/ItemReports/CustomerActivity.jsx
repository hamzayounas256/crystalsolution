...
export default function CustomerActivity() {
	...
	function fetchCustomerActivity() {
		const fromDateElement = document.getElementById("fromdatevalidation");
		const toDateElement = document.getElementById("todatevalidation");
		...
		const apiUrl = apiLinks + "/CustomerActivity.php";
		setIsLoading(true);
	...
	const exportPDFHandler = () => {
		...
		const handlePagination = () => {
			...
			while (currentPageIndex * rowsPerPage < rows.length) {
				...
				startY += 7;
				addTitle(
					`Customer Activity From: ${fromInputDate} To: ${toInputDate}`,
					"",
					"",
					pageNumber,
					startY,
	...
	const handleDownloadCSV = async () => {
		...
		saveAs(blob, "CustomerActivity.xlsx");
	};
	...
	useHotkeys("s", fetchCustomerActivity);
	...
	return (
		<>
			...
			<div style={contentStyle}>
				...
				>
					<NavComponent textdata="Customer Activity" />
					<div
						className="row"
