...
export default function ItemSaleSummary() {
	...
	function fetchItemSaleSummary() {
		...
		const apiMainUrl = apiLinks + "/ItemSaleSummary.php";
		setIsLoading(true);
	...
	useHotkeys("s", fetchItemSaleSummary);
