...
export default function CompanySaleComparison() {
	...
	function fetchCompanySaleComparison() {
		...
		const apiMainUrl = apiLinks + "/CompanySaleComparison.php";
		setIsLoading(true);
	...
	const exportPDFHandler = () => {
		...
		handlePagination();
		doc.save(
			`CompanySaleComparisonReportFrom${fromInputDate}To${toInputDate}.pdf`
		);
	...
	const handleDownloadCSV = async () => {
		...
		saveAs(
			blob,
			`CompanySaleComparisonReportFrom${fromInputDate}To${toInputDate}.xlsx`
		);
	};
	...
	useHotkeys("s", fetchCompanySaleComparison);
				...
				>
					...
					>
						...
						<SingleButton
							...
							text="Select"
							ref={selectButtonRef}
							onClick={fetchCompanySaleComparison}
							style={{ backgroundColor: "#186DB7", width: "120px" }}
							onFocus={(e) => (e.currentTarget.style.border = "2px solid red")}
							onBlur={(e) =>
								(e.currentTarget.style.border = `1px solid ${fontcolor}`)
