...
export default function EmployeeSaleReport() {
	...
	function fetchEmployeeSaleReport() {
		...
		const apiMainUrl = apiLinks + "/EmployeeSaleReport.php";
		setIsLoading(true);
	...
	const exportPDFHandler = () => {
		...
		const columnWidths = [20, 12, 10, 80, 20, 10, 15];
		...
		handlePagination();
		doc.save("EmployeeSaleReport.pdf");
	...
	const handleDownloadCSV = async () => {
		...
		[12, 7, 6, 45, 12, 7, 15].forEach((width, index) => {
		...
		saveAs(blob, "EmployeeSaleReport.xlsx");
	};
	...
	useHotkeys("s", fetchEmployeeSaleReport);
				...
				>
					...
					>
						...
						<SingleButton
							...
							text="Select"
							ref={selectButtonRef}
							onClick={fetchEmployeeSaleReport}
							style={{ backgroundColor: "#186DB7", width: "120px" }}
							onFocus={(e) => (e.currentTarget.style.border = "2px solid red")}
							onBlur={(e) =>
								(e.currentTarget.style.border = `1px solid ${fontcolor}`)
