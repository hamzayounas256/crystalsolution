...
export default function EmployeeMarginSummary() {
	...
	function fetchEmployeeMarginSummary() {
		...
		const apiMainUrl = apiLinks + "/EmployeeMarginSummary.php";
		setIsLoading(true);
	...
	const exportPDFHandler = () => {
		...
		handlePagination();
		doc.save("EmployeeMarginSummary.pdf");
	...
	const handleDownloadCSV = async () => {
		...
		saveAs(blob, "EmployeeMarginSummary.xlsx");
	};
	...
	return (
		<>
			...
			<div style={contentStyle}>
				...
				>
					<NavComponent textdata="Employee Margin Summary" />
					...
					>
						...
						<SingleButton
							...
							text="Select"
							ref={selectButtonRef}
							onClick={fetchEmployeeMarginSummary}
							style={{ backgroundColor: "#186DB7", width: "120px" }}
							onFocus={(e) => (e.currentTarget.style.border = "2px solid red")}
							onBlur={(e) =>
								(e.currentTarget.style.border = `1px solid ${fontcolor}`)
